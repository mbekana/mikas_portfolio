  ...
  if (mobile) {
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn icon={GitHub} m={1} href="https://github.com/mbekana" />
        <IconBtn
          icon={Instagram}
          m={1}
          href="https://instagram.com/mike_bekana?igshid=MzNlNGNkZWQ4Mg=="
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
          href="https://www.linkedin.com/in/milkias-bekana-6905ba208/"
        />
        <IconBtn icon={Email} m={1} href="mailto:mikagrace36@gmail.com" />
      </div>
    );
  } else {
    return (
      <motion.div className={classes.wrapper}>
        ...
        <motion.div animate={controls} custom={1}>
          <IconBtn
            icon={Instagram}
            m={1}
            href="https://www.instagram.com/mehdibha/"
          />
        </motion.div>
